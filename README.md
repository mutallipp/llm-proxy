...
- 🧭 **[Backend Architecture](docs/architecture/backend.md)** - Backend modules, request pipeline, Adapter runtime and troubleshooting
- 🖥️ **[Frontend Architecture](docs/architecture/frontend.md)** - Frontend pages, API boundaries, UI state and verification
...
1. **Download the latest release** from [GitHub Releases](https://github.com/mutallipp/llm-proxy/releases)
...
Download the latest release from [GitHub Releases](https://github.com/mutallipp/llm-proxy/releases)
