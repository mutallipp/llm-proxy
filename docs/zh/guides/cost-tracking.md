...
llm-proxy 为每一次请求提供实时的成本计算和用量追踪。

## 概述

llm-proxy 的成本追踪功能帮助您监控和控制跨所有供应商和模型的 AI 支出。每个请求都会被自动分析，并根据可配置的定价计算成本。

## 功能特性

### Token 类型追踪

llm-proxy 追踪以下 Token 类型：
...
![模型定价](../../screenshots/llm-proxy-model-price.png)
