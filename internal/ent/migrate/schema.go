...
var (
	...
	// AdaptersColumns holds the columns for the "adapters" table.
	AdaptersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "deleted_at", Type: field.TypeInt, Default: 0},
	...
	// AdaptersTable holds the schema information for the "adapters" table.
	AdaptersTable = &schema.Table{
		Name:       "adapters",
		Columns:    AdaptersColumns,
		PrimaryKey: []*schema.Column{AdaptersColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "adapters_by_name",
				Unique:  true,
				Columns: []*schema.Column{AdaptersColumns[4], AdaptersColumns[3]},
			},
		},
	}
	// AdapterModelBindingsColumns holds the columns for the "adapter_model_bindings" table.
	AdapterModelBindingsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "deleted_at", Type: field.TypeInt, Default: 0},
		{Name: "source_model_id", Type: field.TypeString},
	...
	AdapterModelBindingsTable = &schema.Table{
		Name:       "adapter_model_bindings",
		Columns:    AdapterModelBindingsColumns,
		PrimaryKey: []*schema.Column{AdapterModelBindingsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "adapter_model_bindings_adapters_model_bindings",
				Columns:    []*schema.Column{AdapterModelBindingsColumns[7]},
				RefColumns: []*schema.Column{AdaptersColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
		...
		Indexes: []*schema.Index{
			{
				Name:    "adapter_model_bindings_by_adapter_model",
				Unique:  true,
	...
	ProviderQuotaStatusColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "deleted_at", Type: field.TypeInt, Default: 0},
		{Name: "provider_type", Type: field.TypeEnum, Enums: []string{"claudecode", "codex", "github_copilot", "nanogpt", "cline", "wafer", "synthetic", "neuralwatt", "apertis", "opencode_go", "kimi_code", "minimax", "zhipu", "qianwen"}},
	...
	RequestsColumns = []*schema.Column{
		...
		{Name: "request_body_availability", Type: field.TypeEnum, Enums: []string{"unknown", "available", "unavailable"}, Default: "unknown"},
		{Name: "response_body", Type: field.TypeJSON, Nullable: true},
		{Name: "response_body_availability", Type: field.TypeEnum, Enums: []string{"unknown", "available", "unavailable"}, Default: "unknown"},
		{Name: "response_chunks", Type: field.TypeJSON, Nullable: true},
		{Name: "response_chunks_availability", Type: field.TypeEnum, Enums: []string{"unknown", "available", "unavailable", "not_applicable"}, Default: "unknown"},
		{Name: "test_origin_type", Type: field.TypeEnum, Nullable: true, Enums: []string{"channel", "model", "adapter"}},
		{Name: "test_origin_id", Type: field.TypeInt, Nullable: true},
		{Name: "test_origin_label", Type: field.TypeString, Nullable: true, Size: 255},
	...
	RequestsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{RequestsColumns[32]},
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RequestsColumns[32], RequestsColumns[1]},
			},
			{
			...
			{
				Name:    "requests_by_test_origin_type_test_origin_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{RequestsColumns[14], RequestsColumns[15], RequestsColumns[1]},
			},
		},
	}
