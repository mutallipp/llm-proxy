...
import (
	...
	"github.com/mutallipp/llm-proxy/internal/ent/schema"
...
func init() {
	...
	// channelDescProtocolCapabilities is the schema descriptor for protocol_capabilities field.
	channelDescProtocolCapabilities := channelFields[7].Descriptor()
	// channel.DefaultProtocolCapabilities holds the default value on creation for the protocol_capabilities field.
	channel.DefaultProtocolCapabilities = channelDescProtocolCapabilities.Default.(objects.ChannelProtocolCapabilities)
	// channelDescManualModels is the schema descriptor for manual_models field.
	channelDescManualModels := channelFields[8].Descriptor()
	...
	channelDescAutoSyncSupportedModels := channelFields[9].Descriptor()
	...
	channelDescAutoSyncModelPattern := channelFields[10].Descriptor()
