...
func (_m *Request) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.RequestBodyAvailability); err != nil {
		return nil, err
	}
	node.Fields[12] = &Field{
		Type:  "request.RequestBodyAvailability",
		Name:  "request_body_availability",
		Value: string(buf),
	}
	...
	if buf, err = json.Marshal(_m.ResponseBodyAvailability); err != nil {
		return nil, err
	}
	node.Fields[14] = &Field{
		Type:  "request.ResponseBodyAvailability",
		Name:  "response_body_availability",
		Value: string(buf),
	}
	...
	if buf, err = json.Marshal(_m.ResponseChunksAvailability); err != nil {
		return nil, err
	}
	node.Fields[16] = &Field{
		Type:  "request.ResponseChunksAvailability",
		Name:  "response_chunks_availability",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ChannelID); err != nil {
		return nil, err
	...
	if buf, err = json.Marshal(_m.TestOriginType); err != nil {
		return nil, err
	}
	node.Fields[18] = &Field{
		Type:  "request.TestOriginType",
		Name:  "test_origin_type",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.TestOriginID); err != nil {
		return nil, err
	}
	node.Fields[19] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(_m.TestOriginLabel); err != nil {
		return nil, err
	}
	node.Fields[20] = &Field{
		Type:  "string",
		Name:  "test_origin_label",
		Value: string(buf),
	}
...
func (_m *RequestExecution) Node(ctx context.Context) (node *Node, err error) {
	...
	node.Fields[10] = &Field{
		Type:  "requestexecution.RequestBodyAvailability",
		Name:  "request_body_availability",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ResponseBody); err != nil {
	...
	node.Fields[12] = &Field{
		Type:  "requestexecution.ResponseBodyAvailability",
		Name:  "response_body_availability",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ResponseChunks); err != nil {
	...
	node.Fields[14] = &Field{
		Type:  "requestexecution.ResponseChunksAvailability",
		Name:  "response_chunks_availability",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ErrorMessage); err != nil {
