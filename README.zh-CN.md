...
[![测试状态](https://github.com/mutallipp/llm-proxy/actions/workflows/test.yml/badge.svg)](https://github.com/mutallipp/llm-proxy/actions/workflows/test.yml)
[![Lint 状态](https://github.com/mutallipp/llm-proxy/actions/workflows/lint.yml/badge.svg)](https://github.com/mutallipp/llm-proxy/actions/workflows/lint.yml)
[![Go 版本](https://img.shields.io/github/go-mod/go-version/mutallipp/llm-proxy?logo=go&logoColor=white)](https://golang.org/)
...
1. **下载最新版本** 从 [GitHub Releases](https://github.com/mutallipp/llm-proxy/releases)
   - 选择适合您操作系统的版本：
...
下载最新版本从 [GitHub Releases](https://github.com/mutallipp/llm-proxy/releases)
